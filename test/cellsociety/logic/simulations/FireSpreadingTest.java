...
//        try {
//            Grid grid = new Grid(CSVFileReader.readFile("data/fire_spreading/single_fire.csv"));
...
//        try {
//            Grid grid = new Grid(CSVFileReader.readFile("data/fire_spreading/diagonal_fire.csv"));
...
//        try {
//            Grid grid = new Grid(CSVFileReader.readFile("data/fire_spreading/ring_of_fire.csv"));
